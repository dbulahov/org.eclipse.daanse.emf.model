...
public abstract class AbstractMappingModifier implements CatalogMappingSupplier {
    ...
    protected CatalogMapping modifyCatalog(CatalogMapping catalog2) {
        if (catalog2 != null) {
            ...
            return new_Catalog(annotations, id, description, name, documentation, schemas, dbschemas);
        }
        return null;
    }
    ...
    protected DatabaseSchema dbschema(DatabaseSchema databaseSchema) {
        if (databaseSchema != null) {
            ...
            return new_DatabaseSchema(tables, name, id);
        }
        return null;
    }
    ...
    protected Table table(Table table) {
        if (table != null) {
            ...
            return new_Table(name, columns, schema, description);
        }
        return null;
    }
    ...
    protected Column column(Column column) {
        if (column != null) {
            ...
            return new_Column(name, table, type, typeQualifiers, description);
        }
        return null;
    }
    ...
    protected abstract Column new_Column(
    ...
    protected abstract Table new_Table(
    ...
    protected abstract DatabaseSchema new_DatabaseSchema(List<? extends Table> tables, String name, String id);
    ...
    protected abstract CatalogMapping new_Catalog(
